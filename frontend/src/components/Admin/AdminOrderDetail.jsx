        ...
        <div className="flex h-full shadow-md w-full p-4 gap-3 flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div className="p-2 border border-gray-500 rounded-lg">
                    ...
                    <p className="text-gray-600 mb-2">{orderDetails && (orderDetails.address || (orderDetails.shippingAddress && `${orderDetails.shippingAddress.address1}, ${orderDetails.shippingAddress.address2}, ${orderDetails.shippingAddress.address3}, ${orderDetails.shippingAddress.city}`))}</p>
                </div>
                <div className="p-2 border border-gray-500 rounded-lg">
